...
<div class="container">
				...
				<form class="form-horizontal" action="?do=Update" method="Post">
					...
					<div class="form-group form-group-lg">
						...
						<input type="text" name="name" class="form-control" value="old product name" required="required"/>
						</div>
					</div>
					...
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10 col-md-4">
						<input type="text" name="description" class="form-control" value="old description item" required="required"/>
						</div>
					</div>
					<!-- start price field -->
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10 col-md-4">
						<input type="text" name="price" value="old price" class="form-control" required="required"/>
						</div>
					</div>
					<!-- start Country field -->
					<div class="form-group form-group-lg">
					...
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10 col-md-4">
                            <input type="number" name="qantity" value="old quantity" class="form-control"/>
						</div>
					</div>
