    ...
    <form class="form-horizontal" action="#" method="Post">
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-10 col-md-4">
                <input type="text" name="name" class="form-control" placeholder="Categorie Name" required="required"/>
            </div>
        </div>
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-10 col-md-4">
                <input type="text" name="ordering" placeholder="the order of the Category" class="form-control"/>
            </div>
        </div>
